...
describe.skip("NodeCreateTransaction", function () {
    let env;
    ...
    it("should create and update a network node", async function () {
        ...
        const originalOperatorKey = PrivateKey.fromStringED25519(
            "302e020100300506032b65700422042091132178e72057a1d7528025956fe39b0b847f200ab59b2fdd367017f3087137",
        );

        env.client.setOperator(new AccountId(0, 0, 2), originalOperatorKey);
        ...
        const grpcWebProxyEndpoint = new ServiceEndpoint()
            .setIpAddressV4(new Uint8Array([0x00, 0x01, 0x02, 0x05]))
            .setPort(12345);
        ...
        // Update the node
        const grpcWebProxyEndpointUpdated = new ServiceEndpoint()
            .setIpAddressV4(new Uint8Array([0x00, 0x01, 0x02, 0x06]))
            .setPort(123456);
